window.onload = () => {
  ...
  function setupControls() {
    const controls = [
      ...
      {
        inputId: "foodCount",
        tooltipId: "foodCountTooltip",
        setting: "FOOD_COUNT",
      },
      {
        inputId: "ghostChance",
        tooltipId: "ghostChanceTooltip",
        setting: "GHOST_CHANCE",
      },
      {
        inputId: "trailLength",
        tooltipId: "trailLengthTooltip",
        setting: "TRAIL_LENGTH",
      },
      {
        inputId: "rageRadius",
        tooltipId: "rageRadiusTooltip",
        setting: "RAGE_RADIUS",
      },
      {
        inputId: "foodRadius",
        tooltipId: "foodRadiusTooltip",
        setting: "FOOD_RADIUS",
      },
      {
        inputId: "antSpeed",
        tooltipId: "antSpeedTooltip",
        setting: "ANT_SPEED",
      },
    ];
  ...
  function updateAnts() {
    for (let ant of ants) {
      ...
      ant.x =
        (ant.x + Math.cos(ant.angle) * settings.ANT_SPEED + canvas.width) %
        canvas.width;
      ant.y =
        (ant.y + Math.sin(ant.angle) * settings.ANT_SPEED + canvas.height) %
        canvas.height;
